...
Function InstallTitusProgs {
	...
	Start-BitsTransfer -Source "https://raw.githubusercontent.com/codemoxy/win10-debloat-scripts/master/ooshutup10.cfg" -Destination ooshutup10.cfg
...
Function InstallJava {
	Write-Output "Installing Java jre8"
	choco install jre8
}
...
Function DisableXboxFeatures {
	$Server = Read-Host -Prompt 'Enter Y for disabling Xbox Feature or N to skip'
	if($Server -le "Y"){
...
Function EnableDarkMode {
	$UserDark = Read-Host -Prompt 'Do you want to enable Dark Mode? "Y" to enable or "N" to skip'
	if($UserDark -le "Y"){  
